...
var businessLabel = document.querySelector('[for=fos_user_profile_form_business]');
var professionLabel = document.querySelector('[for=fos_user_profile_form_profession]');

var wilderOpt = document.getElementById('fos_user_profile_form_statut_0');
var oldWilderOpt = document.getElementById('fos_user_profile_form_statut_1');
var staffOpt = document.getElementById('fos_user_profile_form_statut_2');
